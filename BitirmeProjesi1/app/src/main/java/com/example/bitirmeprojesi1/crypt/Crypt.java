...
public class Crypt {
    ...
    com.example.bitimeprojesi22.crypt.Permutation permutationObject=new com.example.bitimeprojesi22.crypt.Permutation ();

     //Caesar caesarObject=new Caesar ();
    com.example.bitimeprojesi22.crypt.Caesar caesarObject=new com.example.bitimeprojesi22.crypt.Caesar();
     ...
     public  String decrypt(String data){
         ...
         try{
             ...
             decryptedText=caesarObject.encryption (data,caesarObject.alfabet.length ()-12);
